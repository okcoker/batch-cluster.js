export { EventEmitter } from 'https://deno.land/std@0.122.0/node/events.ts';
...
export { default as seedrandom } from 'https://cdn.skypack.dev/seedrandom@3.0.5';
// export * as split2 from "https://cdn.skypack.dev/split2@4.1.0";
